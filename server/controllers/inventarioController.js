...
export const getAllInsumosWithStock = async (req, res) => {
    try {
      ...
      console.error('Error en getAllInsumosWithStock:', error)
  ...
  export const getInsumosWithStock = async (req, res) => {
    ...
    try {
      ...
      console.error('Error en getInsumosWithStock:', error)
      res.status(500).json({ success: false, message: error.message })
    }
  ...
  export const getInsumosWithPositiveStock = async (req, res) => {
    ...
    try {
      ...
      console.error('Error en getInsumosWithPositiveStock:', error)
      res.status(500).json({ success: false, message: error.message })
    }
...
export const generarPlantillaReabastecimiento = async (req, res) => {
    try {
        ...
        const [insumos_laboratorios] = await pool.execute(`
    ...
    try {
        ...
        for (const dato of datosReabastecimiento) {
            ...
            datosValidados.push({
                ...
                //laboratorio_id: item.lab_id,
                //laboratorio_codigo: item.lab_codigo,
                //laboratorio_nombre: item.lab_nombre,
